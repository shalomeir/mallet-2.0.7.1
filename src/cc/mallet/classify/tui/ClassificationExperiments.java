...
/**
 * A <code>ClassificationExperiments</code> is training and test process for classification using classifier mallet binary or training by documents. And run trials and test.
 * Lastly, print or store output statistics evaluation result.
 * This class is created from <code>Vectors2Classify</code>.java class.
 * <p/>
 * <h4>Goal</h4>
 * <p/>
 * <p>This is all experiments feature involved for classification experiments.
 * @author Seonggyu Lee <a href="mailto:shalomeir@kaist.ac.kr">shalomeir@kaist.ac.kr</a>
 * @version 0.0.1 4.14.2014
 */

public abstract class ClassificationExperiments
{
  static BshInterpreter interpreter = new BshInterpreter();

	private static Logger logger = MalletLogger.getLogger(ClassificationExperiments.class.getName());
	private static Logger progressLogger = MalletProgressMessageLogger.getLogger(ClassificationExperiments.class.getName() + "-pl");
  ...
  private static String[][] ReportOptionArgs = new String[3][4];  //arg in dataset:reportOption=arg
	...
	static CommandOption.SpacedStrings report = new CommandOption.SpacedStrings
		(ClassificationExperiments.class, "report", "[train|test|validation]:[accuracy|f1:label|confusion|raw]",
      ...
      (ClassificationExperiments.class, "trainer", "ClassifierTrainer constructor",  true, "new NaiveBayesTrainer()",
	...
	static CommandOption.String outputFile = new CommandOption.String
		(ClassificationExperiments.class, "output-classifier", "FILENAME", true, "classifier.mallet",
	...
	static CommandOption.String inputFile = new CommandOption.String
		(ClassificationExperiments.class, "input", "FILENAME", true, "text.vectors",
    ...
    static CommandOption.String trainingFile = new CommandOption.String
		(ClassificationExperiments.class, "training-file", "FILENAME", true, "text.vectors",
    ...
    static CommandOption.String testFile = new CommandOption.String
		(ClassificationExperiments.class, "testing-file", "FILENAME", true, "text.vectors",
    ...
    static CommandOption.String validationFile = new CommandOption.String
		(ClassificationExperiments.class, "validation-file", "FILENAME", true, "text.vectors",
	...
	static CommandOption.Double trainingProportionOption = new CommandOption.Double
		(ClassificationExperiments.class, "training-portion", "DECIMAL", true, 1.0,
	...
	static CommandOption.Double validationProportionOption = new CommandOption.Double
		(ClassificationExperiments.class, "validation-portion", "DECIMAL", true, 0.0,
	...
	static CommandOption.Double unlabeledProportionOption = new CommandOption.Double
		(ClassificationExperiments.class, "unlabeled-portion", "DECIMAL", true, 0.0,
	...
	static CommandOption.Integer randomSeedOption = new CommandOption.Integer
		(ClassificationExperiments.class, "random-seed", "INTEGER", true, 0,
	...
	static CommandOption.Integer numTrialsOption = new CommandOption.Integer
		(ClassificationExperiments.class, "num-trials", "INTEGER", true, 1,
	...
	static CommandOption.Object classifierEvaluatorOption = new CommandOption.Object
		(ClassificationExperiments.class, "classifier-evaluator", "CONSTRUCTOR", true, null,
	...
	static CommandOption.Integer verbosityOption = new CommandOption.Integer
		(ClassificationExperiments.class, "verbosity", "INTEGER", true, -1,
	...
	static CommandOption.Boolean noOverwriteProgressMessagesOption = new CommandOption.Boolean
		(ClassificationExperiments.class, "noOverwriteProgressMessages", "true|false", false, false,
	...
	(ClassificationExperiments.class, "cross-validation", "INT", true, 0,
	...
	public static void main (String[] args) throws bsh.EvalError, IOException
	{
		...
		CommandOption.setSummary (ClassificationExperiments.class,
								  "A tool for training, saving and printing diagnostics from a classifier on vectors.");
		CommandOption.process (ClassificationExperiments.class, args);
    ...
    String[] trainerNames = new String[numTrainers];
      ...
      if (unlabeledProportionOption.value > 0)
        unlabeledIndices = new Randoms(r.nextInt())
	...
	private static ClassifierTrainer getTrainer(String arg) {
	  ...
	  for (int i=1; i<fields.length; i++){
	    ...
	    String parameterValue = nameValuePair[1];  //todo: check for val present!
